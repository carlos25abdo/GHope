...
// Google Apps Script جاهز لحذف المحلات من Google Sheets
// انسخ هذا الكود بالكامل إلى https://script.google.com/
...
function deleteShopManually(shopName) {
  const sheetId = '1MUFoYd4Mc_GrrjCMAEMK-GlgVZL1dkMpxEz56Mf7rxE'; // معرف الجدول الخاص بك
  const spreadsheet = SpreadsheetApp.openById(sheetId);
